...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        wd.find_element_by_name("home").send_keys("+74951234567")
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("+79031234567")
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys("+74961234567")
        wd.find_element_by_name("fax").click()
        wd.find_element_by_name("fax").clear()
        wd.find_element_by_name("fax").send_keys("+74961234560")
        ...
        wd.find_element_by_name("homepage").send_keys("http://example.com")
